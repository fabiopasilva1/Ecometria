(function ($) {
    ...
    var Unicom = {
        ...
        Form: function () {
            ...
            $('.affa-form-contact_old').submit(function () {
                var $form = $(this);
        ...
        Button: function () {
            ...
            //btn-user
            $('#navigation .navbar-secondary .btn-user, #navigation .navbar-secondary .navbar-user').on('mouseenter', function () {
                var $user = $(this).parents('.navbar-secondary').find('.navbar-user');
            ...
            $('#navigation .navbar-secondary .btn-user, #navigation .navbar-secondary .navbar-user').on('mouseleave', function () {
                $(this).parents('.navbar-secondary').find('.navbar-user').removeClass('in');
            });

            $('#nav-mobile-top .navbar-secondary .btn-user').on('click', function (e) {
                var $user = $(this).parents('.navbar-secondary').find('.navbar-user');
            ...
            $('#navigation .navbar-secondary .btn-user, #navigation .navbar-secondary .navbar-settings').on('mouseenter', function () {
                var $user = $(this).parents('.navbar-secondary').find('.navbar-settings');

                if (!$user.hasClass('in')) {
                    $user.addClass('in');
                }
            });
            $('#navigation .navbar-secondary .btn-user, #navigation .navbar-secondary .navbar-settings').on('mouseleave', function () {
                $(this).parents('.navbar-secondary').find('.navbar-settings').removeClass('in');
            });
            $('#nav-mobile-top .navbar-secondary .btn-user').on('click', function (e) {
                var $user = $(this).parents('.navbar-secondary').find('.navbar-settings');
