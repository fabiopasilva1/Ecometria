module.exports = ({ env }) => ({
  ...
  'website-builder': {
    enabled: true,
    config: {
      url: 'http://api.nodejsng10f03.kinghost.net:21075/',
      trigger: {
        type: 'manual',
      },
    }
  ...
  email: {
    config: {
      ...
      settings: {
        defaultFrom: 'presstencao@gmail.com',
        defaultReplyTo: 'fabio.presstencao@gmail.com',
        testAddress: 'presstencao@gmail.com',
      },
    },
  },
  // ...
